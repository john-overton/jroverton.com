...
import { countRoutes, countTrips, recalculateServiceWindow, upsertTrips, saveSessionState } from '@/lib/parallax/session-db';
...
export async function POST(
  ...
  try {
    ...
    const { inserted, updated } = upsertTrips(token, trips);
